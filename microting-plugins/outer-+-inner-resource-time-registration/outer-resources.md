...
{% api-method method="post" host="http://localhost:5000" path="/api/outer-inner-resource-pn/outer-resource" %}
{% api-method-summary %}
...
{% api-method-parameter name="relatedInnerResourceIds" type="array" required=false %}
List of inner resource ids
{% endapi-method-parameter %}
